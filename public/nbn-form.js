...
function validateStep1() {
  ...
  if (nbnState.acctType === 'personal') {
    ...
    if (valid) {
	  ...
	  nbnState.phone     = document.getElementById('phone').value.trim();
...
function selectModem(choice) {
  ...
  // BYO info box ko direct show/hide karo
  if (choice === 'byo') {
...
function showSuccessScreen() {
  ...
  localStorage.removeItem('foxus_nbn_state');
  localStorage.removeItem('foxus_nbn_done');
  localStorage.removeItem('foxus_success_screen');
